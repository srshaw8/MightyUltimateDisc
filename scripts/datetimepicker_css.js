...
var SpanBorderColor = "#999999";//span border color 
var SpanBgColor = "#888888";//span background color
var WeekChar=2;//number of character for week day. if 2 then Mo,Tu,We. if 3 then Mon,Tue,Wed.
var DateSeparator="-";//Date Separator, you can change it to "-" if you want.
var ShowLongMonth=true;//Show long month name in Calendar header. example: "January".
var ShowMonthYear=true;//Show Month and Year in Calendar header.
var MonthYearColor="#222222";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#4F6135";//Background Color in Week header.
var SundayColor="#D3E0C2";//Background color of Sunday.
var SaturdayColor="#D3E0C2";//Background color of Saturday.
var WeekDayColor="#FFFFFF";//Background color of weekdays.
var FontColor="#444444";//color of font in Calendar day cell.
var TodayColor="#EC7500";//Background color of today.
var SelDateColor="#FFB769";//Backgrond color of selected date in textbox.
var YrSelColor="#4F6135";//color of font of Year selector.
var MthSelColor="#4F6135";//color of font of Month selector if "MonthSelector" is "arrow".
