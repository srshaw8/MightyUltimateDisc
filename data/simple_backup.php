...
$dbuser = "db63137_backup";            // Database username
$dbpwd = "415dumppass";            // Database password
$dbname = "db63137_mu";            // Database name. Use --all-databases if you have more than one
$filename= "/home/63137/data/backup/backup_prod-$datestamp.sql.gz";   // The name (and optionally path) of the dump file
...
$subject = "MightyUltimate Prod Backup";      // Subject of email
